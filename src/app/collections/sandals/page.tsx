...
export default function SandalsPage() {
  ...
  const filteredProducts = sandalsProducts.filter(product => {
      ...
      <div className="bg-primary text-primary-foreground py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Sandals Collection</h1>
            <p className="text-xl text-primary-foreground/90">
              Step into summer with our collection of stylish sandals. 
              From flat sandals to heeled styles, perfect for warm weather.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-8">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground">Sandals</span>
          </div>
        </nav>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <Select value={filterBy} onValueChange={setFilterBy}>
              ...
              <SelectContent>
                <SelectItem value="all">All Sandals</SelectItem>
                <SelectItem value="flat-sandals">Flat Sandals</SelectItem>
                <SelectItem value="heeled-sandals">Heeled Sandals</SelectItem>
                <SelectItem value="wedge-sandals">Wedge Sandals</SelectItem>
        ...
        <div className="mb-6">
          <p className="text-muted-foreground">
            Showing {sortedProducts.length} of {sandalsProducts.length} products
          </p>
        </div>
