...
export default function BootsPage() {
  ...
  const filteredProducts = bootsProducts.filter(product => {
      ...
      <div className="bg-primary text-primary-foreground py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Boots Collection</h1>
            <p className="text-xl text-primary-foreground/90">
              Step into style with our collection of premium boots. 
              From ankle boots to over-the-knee styles, perfect for any season.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-8">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground">Boots</span>
          </div>
        </nav>
        ...
        <div className="mb-6">
          <p className="text-muted-foreground">
            Showing {sortedProducts.length} of {bootsProducts.length} products
          </p>
        </div>
