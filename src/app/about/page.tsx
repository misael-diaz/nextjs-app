      ...
      <main className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="text-center mb-16 relative">
          ...
          <div className="relative bg-gradient-to-br from-background/90 via-background/80 to-background/90 backdrop-blur-md rounded-3xl p-12 border-2 border-primary/20 shadow-2xl">
            <h1 className="text-5xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-foreground via-primary to-secondary bg-clip-text text-transparent">
              Where Fashion
              <br />
              <span className="text-primary drop-shadow-lg">Flows</span>
            </h1>
