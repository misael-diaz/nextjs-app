...
const products = {
  ...
  'stevie-knee-high-suede-black': {
    id: 'stevie-knee-high-suede-black',
    name: 'Stevie Knee-High Boots in Black Suede',
    price: '$198.00',
    originalPrice: null,
    image: '/knee-high-boots-black-new.jpg',
    images: ['/knee-high-boots-black-new.jpg', '/boot2.jpg', '/boot3.jpg', '/boot4.jpg'],
    category: 'Boots',
    subcategory: 'Knee-high',
    description: 'These elegant knee-high boots are crafted from soft black suede, featuring a sleek design suitable for various occasions. The timeless silhouette pairs perfectly with dresses, skirts, and skinny jeans.',
    features: [
      'Premium black suede upper',
      'Knee-high silhouette',
      'Comfortable heel height',
      'Versatile styling options',
      'Crafted for durability'
  ...
  'stevie-knee-high-suede-brown': {
    id: 'stevie-knee-high-suede-brown',
    name: 'Stevie Knee-High Boots in Brown Suede',
    price: '$198.00',
    originalPrice: null,
    image: '/knee-high-boots-brown-new.jpg',
    images: ['/knee-high-boots-brown-new.jpg', '/boot2.jpg', '/boot3.jpg', '/boot4.jpg'],
    category: 'Boots',
    subcategory: 'Knee-high',
    description: 'These elegant knee-high boots are crafted from soft brown suede, featuring a sleek design suitable for various occasions. The timeless silhouette pairs perfectly with dresses, skirts, and skinny jeans.',
    features: [
      'Premium brown suede upper',
      'Knee-high silhouette',
      'Comfortable heel height',
      'Versatile styling options',
      'Crafted for durability'
  ...
  'stevie-knee-high-suede-tan': {
    id: 'stevie-knee-high-suede-tan',
    name: 'Stevie Knee-High Boots in Tan Suede',
    price: '$198.00',
    originalPrice: null,
    image: '/knee-high-boots-tan-new.jpg',
    images: ['/knee-high-boots-tan-new.jpg', '/boot2.jpg', '/boot3.jpg', '/boot4.jpg'],
    category: 'Boots',
    subcategory: 'Knee-high',
    description: 'These elegant knee-high boots are crafted from soft tan suede, featuring a sleek design suitable for various occasions. The timeless silhouette pairs perfectly with dresses, skirts, and skinny jeans.',
    features: [
      'Premium tan suede upper',
      'Knee-high silhouette',
      'Comfortable heel height',
      'Versatile styling options',
      'Crafted for durability'
  ...
  'stevie-ankle-leopard': {
    ...
    image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600&h=600&fit=crop&crop=center&hue=30&sat=80',
  ...
  'stevie-ankle-stretch': {
    ...
    image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600&h=600&fit=crop&crop=center&brightness=0.3&contrast=1.5',
  ...
  'classic-heel-black': {
    ...
    price: '$198.00',
    originalPrice: null,
    image: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=600&h=600&fit=crop&crop=center&brightness=0.3&contrast=1.5',
  ...
  'block-heel-nude': {
    ...
    price: '$168.00',
    originalPrice: null,
    image: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=600&h=600&fit=crop&crop=center&sat=-30&brightness=1.2',
  ...
  'ballet-flat-nude': {
    ...
    images: ['/ballet-flat-nude-new.jpg', '/flat2.jpg', '/flat3.jpg', '/flat4.jpg'],
    category: 'Flats',
    subcategory: 'Ballet Flats',
    description: 'The perfect everyday flat that combines comfort and style. These classic ballet flats feature a soft nude leather upper and flexible sole for all-day comfort.',
    features: [
      'Soft nude leather upper',
      'Flexible sole',
      'All-day comfort',
      'Classic silhouette',
      'Versatile styling'
  ...
  'ballet-flat-red': {
    ...
    images: ['/ballet-flat-red-pexels.jpg', '/flat2.jpg', '/flat3.jpg', '/flat4.jpg'],
    category: 'Flats',
    subcategory: 'Ballet Flats',
    description: 'The perfect everyday flat that combines comfort and style. These classic ballet flats feature a soft red leather upper and flexible sole for all-day comfort.',
    features: [
      'Soft red leather upper',
      'Flexible sole',
      'All-day comfort',
      'Classic silhouette',
      'Versatile styling'
  ...
  'ballet-flat-navy': {
    ...
    images: ['/ballet-flat-navy-new.jpg', '/flat2.jpg', '/flat3.jpg', '/flat4.jpg'],
    category: 'Flats',
    subcategory: 'Ballet Flats',
    description: 'The perfect everyday flat that combines comfort and style. These classic ballet flats feature a soft navy leather upper and flexible sole for all-day comfort.',
    features: [
      'Soft navy leather upper',
      'Flexible sole',
      'All-day comfort',
      'Classic silhouette',
      'Versatile styling'
  ...
  'canvas-sneaker-white': {
    ...
    price: '$78.00',
    originalPrice: null,
    image: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=600&h=600&fit=crop&crop=center&brightness=1.5&contrast=1.2',
  ...
  'canvas-sneaker-black': {
    id: 'canvas-sneaker-black',
    name: 'Canvas Sneakers in Black',
    price: '$88.00',
    originalPrice: null,
    image: '/canvas-sneakers-black-new.jpg',
    images: ['/canvas-sneakers-black-new.jpg', '/sneaker2.jpg', '/sneaker3.jpg', '/sneaker4.jpg'],
    category: 'Sneakers',
    subcategory: 'Canvas',
    description: 'Clean, classic style meets everyday comfort in these black canvas sneakers. Perfect for casual outings, weekend adventures, or adding a sporty touch to any outfit.',
    features: [
      'Premium canvas upper',
      'Rubber sole',
  ...
  'canvas-sneaker-navy': {
    ...
    images: ['/canvas-sneakers-navy-new.jpg', '/sneaker2.jpg', '/sneaker3.jpg', '/sneaker4.jpg'],
    category: 'Sneakers',
    subcategory: 'Canvas',
    description: 'Clean, classic style meets everyday comfort in these navy canvas sneakers. Perfect for casual outings, weekend adventures, or adding a sporty touch to any outfit.',
    features: [
      'Premium canvas upper',
      'Rubber sole',
      'Classic navy design',
  ...
  'leather-sandal-brown': {
    ...
    originalPrice: null,
    image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600&h=600&fit=crop&crop=center',
    images: ['/leather-sandal-brown.jpg', '/strappy-sandal-black-new.jpg', '/slide-sandal-white-new.jpg', '/wedge-sandal-tan-new.jpg'],
    category: 'Sandals',
    subcategory: 'Strappy',
  ...
  'three-strap-slide-sandals': {
    ...
    image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600&h=600&fit=crop&crop=center&brightness=1.5&contrast=1.2',
    images: ['/three-strap-slide-sandals.jpg', '/strappy-sandal-black-new.jpg', '/slide-sandal-white-new.jpg', '/wedge-sandal-tan-new.jpg'],
    category: 'Sandals',
    subcategory: 'Slide',
  ...
  'fisherman-wedge-sandals': {
    ...
    price: '$56.50',
    originalPrice: '$128.00',
    image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600&h=600&fit=crop&crop=center&sat=-50',
    images: ['/fisherman-wedge-sandals.jpg', '/strappy-sandal-black-new.jpg', '/slide-sandal-white-new.jpg', '/wedge-sandal-tan-new.jpg'],
    category: 'Sandals',
    subcategory: 'Wedge',
  ...
  'platform-heel-black': {
    ...
    originalPrice: '$268.00',
    image: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=600&h=600&fit=crop&crop=center&brightness=0.3&contrast=1.5',
    images: ['/platform-heel-black.jpg', '/heel1.jpg', '/heel2.jpg', '/heel3.jpg'],
    category: 'Heels',
  ...
  'designer-mules': {
    ...
    image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600&h=600&fit=crop&crop=center&brightness=0.3&contrast=1.5',
    images: ['/designer-mules-black.jpg', '/flat1.jpg', '/flat2.jpg', '/flat3.jpg'],
    category: 'Flats',
    subcategory: 'Mules',
  ...
  'heeled-sandals': {
    ...
    price: '$129.00',
    image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600&h=600&fit=crop&crop=center&sat=-30&brightness=1.2',
    images: ['/heeled-sandals-nude.jpg', '/heeled-sandal-gold-new.jpg', '/strappy-sandal-black-new.jpg', '/slide-sandal-white-new.jpg'],
    category: 'Sandals',
    subcategory: 'Heeled',
  ...
  'wedge-sandals': {
    ...
    price: '$109.00',
    image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600&h=600&fit=crop&crop=center&sat=-50',
    images: ['/wedge-sandals-natural.jpg', '/wedge-sandal-tan-new.jpg', '/strappy-sandal-black-new.jpg', '/slide-sandal-white-new.jpg'],
    category: 'Sandals',
    subcategory: 'Wedge',
  ...
  'designer-slides': {
    ...
    image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600&h=600&fit=crop&crop=center&brightness=0.3&contrast=1.5',
    images: ['/designer-slides-black.jpg', '/designer-sandal-nude-new.jpg', '/strappy-sandal-black-new.jpg', '/slide-sandal-white-new.jpg'],
    category: 'Sandals',
    subcategory: 'Slide',
  ...
  'combat-boots': {
    ...
    image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600&h=600&fit=crop&crop=center&brightness=0.3&contrast=1.5',
    images: ['/combat-boots-black.jpg', '/boot1.jpg', '/boot2.jpg', '/boot3.jpg'],
    category: 'Boots',
    subcategory: 'Combat',
