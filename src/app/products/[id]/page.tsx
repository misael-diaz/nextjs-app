...
const products = {
  ...
  'heeled-sandals': {
    ...
    images: ['/heeled-sandals-nude.jpg', '/sandal1.jpg', '/sandal3.jpg', '/sandal4.jpg'],
    category: 'Sandals',
    subcategory: 'Heeled',
  ...
  'wedge-sandals': {
    ...
    images: ['/wedge-sandals-natural.jpg', '/sandal1.jpg', '/sandal2.jpg', '/sandal4.jpg'],
    category: 'Sandals',
    subcategory: 'Wedge',
  ...
  'designer-slides': {
    ...
    images: ['/designer-slides-black.jpg', '/sandal1.jpg', '/sandal2.jpg', '/sandal3.jpg'],
    category: 'Sandals',
    subcategory: 'Slide',
